...
pois_list <- list(
  parques = get_poi_all(points_bogota, polys_bogota, lines_bogota,
                        key = "leisure", values = "park"),
  colegios = get_poi_all(points_bogota, polys_bogota, lines_bogota,
                         key = "amenity", values = "school"),
  restaurantes = get_poi_all(points_bogota, polys_bogota, lines_bogota,
                             key = "amenity", values = "restaurant"),
  autopistas = get_poi_all(points_bogota, polys_bogota, lines_bogota,
                           key = "highway", values = c("motorway", "trunk", "primary")),
  centros_comerciales = get_poi_all(points_bogota, polys_bogota, lines_bogota,
