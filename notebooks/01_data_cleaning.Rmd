...
#Seleccionamos las variables a imputar
...
#    (Para imputar train y test de forma consistente)
...
# Datos completos (para entrenar el imputador)


complete_rows <- full_data %>% 
  drop_na(surface_total, surface_covered, bedrooms, bathrooms)

# ==========================================
# 4) Separación interna train/test para CV
# ==========================================

set.seed(2025)
index_test <- sample(
  1:nrow(complete_rows),
  size = round(0.2 * nrow(complete_rows)),
  replace = FALSE
)

db_train <- complete_rows[-index_test, ]
db_test  <- complete_rows[index_test, ]
